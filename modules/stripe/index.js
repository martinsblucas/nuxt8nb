...
export default function () {
  ...
  const cloudinaryName = this.options.cloudinary.cloudName
  ...
  this.nuxt.hook('render:setupMiddleware', (app) => {
    app.use('/hooks/stripe', async (req, res) => {
      ...
      const book = await apis.user.bookHome(meta.identityId, meta.homeId, meta.start, meta.end)
      sendJSON({...meta}, res)
    })
  })
      ...
      line_items: [
        {
          ...
          price_data: {
            ...
            product_data: {
              ...
              images: [
                `https://res.cloudinary.com/${cloudinaryName}/image/upload/${home.images[0]}`,
              ],
            },
          },
        },
